...
class Calculator:
    ...
    def calculate(self, *args): 
        ...
        scaling_factor = ((self.diameter_2**2)/(self.diameter_1**2))
        self.flowrate_2 =  self.flowrate_1 * scaling_factor
        self.injection_volume_2 = self.injection_volume_1 * scaling_factor * (self.length_2/self.length_1)
